...
while True: 
    ...
    if action == 'b': 
        ...
        print('Deposit:') 
        user_deposit_ammount = input('Please enter amount to deposit: ') 
        user_deposit_ammount = int(user_deposit_ammount) 
        user_password = input('Please enter the password: ') 
        if user_deposit_ammount < 0: 
            print('You cannot deposit a negative amount!') 
        elif user_password != account_password: 
            print('Incorrect password') 
        else:  
            # OK 
            account_balance = account_balance + user_deposit_ammount 
